...
>
> **O que fica em aberto é a forma da ligação, e ela não é decidida aqui.** Desenhá-la antes de existir o serviço que a consome seria inventar vocabulário para prever o módulo. `07_IMPLEMENTATION_PHASES.md` Fase 3 é quem traz a `academus-api` e o `federated-identity-simulator` que emite o evento.
