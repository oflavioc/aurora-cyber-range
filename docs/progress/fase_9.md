...
| **400 — o declarado** | **96.650** | **1,729 s** (exploratória) · **2,017 s** (a PROVA) | **PASSA, 33% de folga** |
...
> `.aurora-prova-do-exercicio-4h.json` registra **2,017 s** para os mesmos
> 96.650 eventos, e é ele que `check_prova_do_exercicio_4h.py` confere — a §3
> deste registro cita esse valor.
>
> A linha exploratória (1,729 s) e a da prova (2,017 s) diferem em 0,29 s, e
...
> (2,017 s) tem 33% de folga, e cruzar 3 s exigiria um desvio de 0,98 s — o
...
**33% de folga no pior caso medido** e não muda de veredito entre execuções.
...
| **H3** — três números para a mesma medição | a §2.8 e a §3 passam a citar **o número da prova** (2,017 s), e a variância entre a linha exploratória e a prova fica registrada |
