...
| | |
|---|---|
| **1082 testes** | `python -m unittest discover -s tests`, **com a stack no ar e zero pulos** — medido em 22/09/2026, no fechamento da Fase 9. Os 133 acrescentados por ela são unitários (elenco, motor de projeção, geradores, build/verify, telemetria e as seis provas negativas por mutação), e o número **sem** a stack continua sendo 163 a menos. A medição anterior, de 949, é do fechamento da Fase 8 |
...
Sem Postgres no ar, 163 dos 1082 testes pulam — os que exigem banco ou container.
