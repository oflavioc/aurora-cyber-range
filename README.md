...
| | |
|---|---|
| **757 testes** | `python -m unittest discover -s tests`, em 24/08/2026 — 735 deles verdes **com a stack no ar**, sem nenhum pulo; os 11 da P6-11 e os 2 da P5-6 são unitários e foram medidos sem ela. Sem Postgres e Redis, 140 deles pulam |
...
Sem Postgres no ar, 140 dos 757 testes pulam — os que exigem banco ou container.
