...
| | |
|---|---|
| **367 testes** | `python -m unittest discover -s tests`, em 18/08/2026. 105 exigem Postgres ou containers e pulam sem a stack no ar |
...
Sem Postgres no ar, 105 dos 367 testes pulam — os que exigem banco ou container.
