...
| | |
|---|---|
| **510 testes** | `python -m unittest discover -s tests`, em 20/08/2026. 140 exigem Postgres ou containers e pulam sem a stack no ar |
...
Sem Postgres no ar, 140 dos 510 testes pulam — os que exigem banco ou container.
