...
| | |
|---|---|
| **413 testes** | `python -m unittest discover -s tests`, em 19/08/2026. 140 exigem Postgres ou containers e pulam sem a stack no ar |
...
Sem Postgres no ar, 140 dos 413 testes pulam — os que exigem banco ou container.
